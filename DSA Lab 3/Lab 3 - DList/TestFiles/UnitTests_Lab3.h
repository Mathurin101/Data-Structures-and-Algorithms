...
#pragma region Test - List Default Constructor
	static int Battery_ListDefaultConstructor();
...
#pragma region Test - Node Constructor With Defaults
	static int Battery_NodeConstructorWithDefaults();
...
#pragma region Test - AddHead On Empty List
	static int Battery_AddHeadOnEmptyList();
...
#pragma region Test - AddHead On Non-Empty List
	static int Battery_AddHeadOnNonEmptyList();
...
#pragma region Test - AddTail On Empty List
	static int Battery_AddTailOnEmptyList();
...
#pragma region Test - AddTail On Non-Empty List
	static int Battery_AddTailOnNonEmptyList();
...
#pragma region Test - Iterator Begin
	static int Battery_IteratorBegin();
...
#pragma region Test - Iterator End
	static int Battery_IteratorEnd();
...
#pragma region Test - Iterator Increment Pre-Fix
	static int Battery_IteratorIncrementPreFix();

	static FailResult Fail_IteratorIncrementPreFix_AllocatesDynamicMemory();
...
#pragma region Test - Iterator Increment Post-Fix
	static int Battery_IteratorIncrementPostFix();

	static FailResult Fail_IteratorIncrementPostFix_AllocatesDynamicMemory();
...
#pragma region Test - Iterator Decrement Pre-Fix
	static int Battery_IteratorDecrementPreFix();

	static FailResult Fail_IteratorDecrementPreFix_AllocatesDynamicMemory();
...
#pragma region Test - Iterator Decrement Post-Fix
	static int Battery_IteratorDecrementPostFix();

	static FailResult Fail_IteratorDecrementPostFix_AllocatesDynamicMemory();
...
#pragma region Test - Iterator Dereference
	static int Battery_IteratorDereference();
...
#pragma region Test - Insert On Empty List
	static int Battery_InsertOnEmptyList();
...
#pragma region Test - Insert At Head
	static int Battery_InsertAtHead();
	...
	static FailResult Fail_InsertAtHead_SizeIsDoubleIncremented();
...
#pragma region Test - Insert On Non-Empty List
	static int Battery_InsertOnNonEmptyList();
...
#pragma region Test - Erase Middle
	static int Battery_EraseMiddle();
